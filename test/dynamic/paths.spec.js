...
describe('runtime path canonicalization', () => {
	...
	it('creates portable collision and component keys', () => {
		...
		expect(component_runtime_key('/work/app/src/routes/a.svelte?x', '/work/app')).toBe(
			'/src/routes/a.svelte'
		);
		expect(component_runtime_key('/src/routes/a.svelte', '/')).toBe('/src/routes/a.svelte');
	});
