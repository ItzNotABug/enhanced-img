 ...
 * by runtime input; they are derived solely from the transformation profile.
 *
 ...
 * modules with equivalent query/attribute/catalog inputs.
 *
...
function query_error(message) {
	return new TypeError(`@itznotabug/emage-core: ${message}`);
}
